...
public class Main {
	...
	/**
	 * main function
	 * @param args user input including province, cuisine type, latitude and longitude
	 * @return FinalOutput object containing list of restaurant names and distances
	 * @throws IOException 
	 */
