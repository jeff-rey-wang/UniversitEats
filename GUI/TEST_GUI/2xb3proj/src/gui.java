...
public class gui {
	 ...
	 * @param args is an autogenerated parameter made by WindowBuilder
	 * @throws Exception if the GUI runs into an issue.
	 */
	...
	private void initialize() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			/**
			 * "Generate A Restaurant" button
			 * @param e is the ActionEvent button. A restaurant and distance to it will be given once the button is pressed.
			 * @throws IOException if the parsing runs into an issue
			 */
		...
		//Reroll button
		JButton gonext = new JButton("Reroll (Only Press If Already Generated A Restaurant You Did Not Like)");
